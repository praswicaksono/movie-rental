    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/movies" :active="request()->routeIs('movies')">
                        {{ __('Movies') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/members" :active="request()->routeIs('members')">
                        {{ __('Members') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/movie/lending" :active="request()->routeIs('lending')">
                        {{ __('Lending') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/movie/return" :active="request()->routeIs('return')">
                        {{ __('Return') }}
                    </x-jet-nav-link>
                </div>
            </div>
